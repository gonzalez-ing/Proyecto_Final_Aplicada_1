...
{
    public partial class ReportesEntradaProducto : Form
    {

        List<EntradaProductos> datos = new List<EntradaProductos>();
        public ReportesEntradaProducto(List<EntradaProductos> log)
        {
            InitializeComponent();
            datos = log;
        }
        ...
        {
            ReportesEntradasProductos abrir = new ReportesEntradasProductos();
